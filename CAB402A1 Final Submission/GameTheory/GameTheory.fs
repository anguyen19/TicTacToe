            ...
            let rec MiniMax alpha beta oldState perspective =
                ...
                let rec takeMax children row alpha beta =
                    ...
                    if (nextAlpha >= beta || children.Length = 1) then
                        ...
                        takeMax (List.tail children) newRow nextAlpha beta 
